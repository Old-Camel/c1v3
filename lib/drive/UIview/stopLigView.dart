...
class StopLigView extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;
  static AudioCache player = AudioCache(prefix: 'audio/');
  const StopLigView({Key key, this.animationController, this.animation})
      : super(key: key);

  Future<Null> _load() async {
    player.play('l-stop.mp3');
  }
  @override
...
//                        bottom: 2,
                        child: SizedBox(
                          width: 68,
                          height: 67,
                          child: Image.asset("assets/fitness_app/lig.jpeg"),
                        ),
                      )
                    ],
